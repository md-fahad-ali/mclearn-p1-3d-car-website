...
Command: npx gltfjsx@6.2.15 /home/fahad/Desktop/car/public/asset/car_move.glb 
*/
...
export function Model(props) {
  ...
  const getData = useGLTF("/asset/model.gltf");
  console.log(getData);
          ...
          <group name="Scene_1" position={[0.46, -0.22, -2]}>
            <group name="Empty" position={[-0.21, 0.22, 2]} scale={2.437}>
              ...
              <mesh
                ...
                material={materials["HeadlightsEmis.001"]}
                position={[-0.078, -0.183, -0.039]}
                scale={0.316}
                castShadowsive
              />
